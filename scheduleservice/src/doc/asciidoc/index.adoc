...
[[resource-schedule-day-lesson-marks-get]]
=== Getting an information about all marks by the lesson
A `GET` request fetches all marks for lesson.

==== Example request
include::{snippets}/schedule-day-lesson-marks-get/http-request.adoc[]

==== Example response
include::{snippets}/schedule-day-lesson-marks-get/http-response.adoc[]
