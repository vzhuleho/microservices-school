...
include::{snippets}/schedules-days-list/http-request.adoc[]

==== Example response

include::{snippets}/schedules-days-list/http-response.adoc[]
...
include::{snippets}/schedules-days-get/http-response.adoc[]
...
include::{snippets}/schedules-day-lessons-get/http-response.adoc[]